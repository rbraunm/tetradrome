...
"""Tests for the host-platform axis: the /sys parsers (exact), the memory-ceiling logic, and the
per-OS platform classes (structural / live)."""
import pytest

from tetradrome.scheduler.hostplatform import (
    DebianHostPlatform,
    UbuntuHostPlatform,
    WindowsHostPlatform,
    for_host,
