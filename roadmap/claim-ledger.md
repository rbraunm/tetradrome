...
| Native Floer (τ, ε, ν, HFK ranks) | Yellow | grid-homology engine computes HFK-hat ranks and the Seifert genus, validated against KnotInfo (HFK up to mirror; genus = three-genus). τ, ε, ν not yet implemented | Phase 6 (peer engine) in progress; τ next (needs the filtered theory) |
